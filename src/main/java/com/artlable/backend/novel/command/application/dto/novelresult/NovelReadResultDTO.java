...
public class NovelReadResultDTO {
    ...
    public static NovelReadResultDTO fromEntity(NovelResult novelResult) {
        return NovelReadResultDTO.builder()
