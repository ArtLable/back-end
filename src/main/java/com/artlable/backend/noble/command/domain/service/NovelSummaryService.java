...
import com.artlable.backend.noble.command.application.dto.novelsummary.NovelCreateSummary;
import com.artlable.backend.noble.command.application.dto.novelsummary.NovelReadSummary;
import com.artlable.backend.noble.command.application.dto.novelsummary.NovelUpdateSummary;
...
import com.artlable.backend.noble.command.domain.repository.NovelSummaryRepository;
...
public class NovelSummaryService {
    ...
    public List<NovelReadSummary> findNovelAllSummaries() {
        ...
        List<NovelSummary> summaries = novelSummaryRepository.findBySummaryOrderBySummaryNoDesc();
